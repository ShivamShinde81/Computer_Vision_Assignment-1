...
def main():
    ...
    st.header("Computer Vision Assignment-1 ")
    st.subheader("Roll No.180")
...
def uploadImage(key):
    ...
    return cv2.cvtColor(preProcessImg(cv2.imread('testimage1.jpg')), cv2.COLOR_BGR2RGB)
